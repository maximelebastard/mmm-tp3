...
import edu.istic.mmm.mmmtp3.activity.RegionsDetailActivity;
...
public class LocateFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = (FrameLayout) inflater.inflate(R.layout.fragment_locate, container, false);

        mapFragment = SupportMapFragment.newInstance();
        getActivity().getSupportFragmentManager().beginTransaction().add(R.id.location_map, mapFragment).commit();
